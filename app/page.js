  ...
  return (
    <div className="bg-black min-h-screen p-4">
      ...
      <ul className="list-none p-0">
        <li className="mb-2">
          <Link href="/week-2" className="text-white font-semibold hover:text-red-500 transition-colors">Week 2</Link>
        </li>
        <li className="mb-2">
          <Link href="/week-3" className="text-white font-semibold hover:text-red-500 transition-colors">Week 3</Link>
        </li>
        <li className="mb-2">
